...
namespace FileStream.FactoryClasses
{
	...
	{
		private readonly FileStream.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, FileStream.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((FileStream.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public AttachmentEntityFactory() : base("AttachmentEntity", FileStream.EntityType.AttachmentEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(FileStream.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(FileStream.EntityType)))
			{
				var factory = GetFactory((FileStream.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the FileStream.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(FileStream.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case FileStream.EntityType.AttachmentEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the FileStream.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (FileStream.EntityType)Enum.Parse(typeof(FileStream.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((FileStream.EntityType)Enum.Parse(typeof(FileStream.EntityType), leftOperandEntityName, false), joinType, (FileStream.EntityType)Enum.Parse(typeof(FileStream.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (FileStream.EntityType)Enum.Parse(typeof(FileStream.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((FileStream.EntityType)entityTypeValue); }
